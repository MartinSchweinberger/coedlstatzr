...
#'   \item{Interloctutor}{*THIS IS MISPELLED IN THE CODE* Factor representing the gender of the interlocutor (OtherGender versus SameGender).}
#'   \item{Shots}{Number of shots a speaker drank before the converstion.}
#'   ...
#' }
#' @source Fictional data generated for training purposes.
