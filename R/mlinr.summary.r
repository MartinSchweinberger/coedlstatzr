...
#'
#' @description This function produces summary tables for multiple linear regressions by extracting the relevent information from a glm and a lm object.
#' @param mlr A linear regression model object created with the lm function.
#' @param glm A linear regression model glm object of family "gaussian"  created with the glm function.
#' @export
